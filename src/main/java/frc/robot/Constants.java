...
public class Constants {
    ...
    */
    ...
    public static final CANAddress ARM_SHOULDER_RIGHT = new CANAddress(7); // FIXME: Correct CAN ID
    public static final CANAddress ARM_WRIST = new CANAddress(6); // FIXME: Correct CAN ID
