...
public class Constants {
    ...
    */
    ...
    public static final CANAddress TURN_LEFT_FRONT = new CANAddress(13);
    public static final CANAddress TURN_LEFT_REAR = new CANAddress(11);
    ...
    public static final CANAddress DRIVE_LEFT_REAR = new CANAddress(1);
    public static final CANAddress DRIVE_RIGHT_FRONT = new CANAddress(4);
