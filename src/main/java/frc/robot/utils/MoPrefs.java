...
public final class MoPrefs {
    ...
    public static Pref<Double> relShoulderMax = doublePref("Rel. Shoulder Max", 50); // TODO: Find actual value
    public static Pref<Double> absWristZero = doublePref("Abs. Wrist Zero", 0); // TODO: Find actual value
    public static Pref<Double> relWristMax = doublePref("Rel. Wrist Max", 50); // TODO: Find actual value
    public static Pref<Double> shoulderAbsToRel = doublePref("Shoulder Abs:Rel", 1); // TODO: Find actual value
    public static Pref<Double> wristAbsToRel = doublePref("Wrist Abs:Rel", 1); // TODO: Find actual value
