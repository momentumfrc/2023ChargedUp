...
public class Limelight {
    ...
    public void forceLedsOff(boolean shouldTurnOff) {
        this.shouldForceLedsOff = shouldTurnOff;
    }
    ...
    public void periodic() {
        ...
        pipelinePublisher.accept(currentPipeline.id);
        ledPublisher.accept(shouldForceLedsOff ? 1 : 0);
